  ...
  return (
    ...
    >
      ...
      <input
        ...
        required
        maxLength={24}
        className="w-full text-sm border border-ink/10 rounded-lg px-3 py-2.5 placeholder:text-ink-faint focus:border-teal focus:ring-2 focus:ring-teal/20 transition"
      />
      <input
        value={city}
      ...
      <textarea
        ...
        maxLength={200}
        rows={3}
        className="w-full text-sm border border-ink/10 rounded-lg px-3 py-2.5 placeholder:text-ink-faint focus:border-teal focus:ring-2 focus:ring-teal/20 transition resize-none"
      />
